...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($cycle)) {
        $stmt = $pdo->prepare("INSERT INTO zakath_calculations (user_id, cycle_name, cash_balance, gold_silver, investments, liabilities, total_zakath) VALUES (?, ?, ?, ?, ?, ?, ?)");
        $stmt->execute([$_SESSION['user_id'], $cycle, $cash, $gold, $invest, $liab, $zakath]);
            ...
            <form method="POST" id="zakathForm">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="cycle_name" class="form-control form-control-lg" 
                           placeholder="e.g. Ramadan <?php echo date('Y'); ?>" 
                           value="Ramadan <?php echo date('Y'); ?>" required>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" step="0.01" name="cash_balance" id="cash" class="form-control calc-input" required value="0">
                        <button type="button" class="btn btn-outline-secondary" onclick="document.getElementById('cash').value = <?php echo $current_bank_total; ?>; calcZakath();">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <span class="input-group-text">AED</span>
                        <input type="number" step="0.01" name="gold_silver" id="gold" class="form-control calc-input" value="0">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <span class="input-group-text">AED</span>
                        <input type="number" step="0.01" name="investments" id="invest" class="form-control calc-input" value="0">
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <span class="input-group-text">AED</span>
                        <input type="number" step="0.01" name="liabilities" id="liab" class="form-control calc-input" value="0">
                    </div>
