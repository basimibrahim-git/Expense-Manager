...
<div class="mb-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div class="d-flex gap-2 align-items-center">
            ...
            <button class="btn btn-outline-danger fw-bold btn-sm" data-bs-toggle="modal"
                data-bs-target="#globalPendingModal">
                <i class="fa-solid fa-list-ul me-1"></i> Total Due
            </button>

            <!-- Year Dropdown -->
            <form action="" method="GET" class="d-inline-block">
                <select name="year" class="form-select form-select-sm fw-bold border-info text-info"
            ...
            <div class="glass-panel p-4 text-center position-relative overflow-hidden">
                ...
                <div class="position-relative">
                    ...
                    <h2 class="display-5 fw-bold text-info mb-0">
                        <small class="fs-6">AED</small> <span
                            class="blur-sensitive"><?php echo number_format($current_balance, 2); ?></span>
                    </h2>
                </div>
            </div>
        </div>
            ...
            <div class="glass-panel p-4 text-center position-relative overflow-hidden">
                ...
                <div class="position-relative">
                    ...
                    <h2 class="display-5 fw-bold text-success mb-0">
                        <small class="fs-6">AED</small> <span
                            class="blur-sensitive"><?php echo number_format($total_paid, 2); ?></span>
                    </h2>
                </div>
            </div>
        </div>
